...
import { Search, Calendar, User, ArrowRight, Eye, MessageCircle, Share2 } from "lucide-react";
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Đánh giá toàn diện về Porsche 911 Carrera S 2024, từ thiết kế, hiệu suất đến giá trị đầu tư. Có nên mua hay không?",
    ...
    },
    {
      ...
      excerpt: "Phân tích chi tiết về tình hình thị trường xe hạng sang tại Việt Nam, những thay đổi trong thị hiếu khách hàng và dự báo cho năm 2025.",
    ...
    },
    {
      ...
      excerpt: "Hướng dẫn chi tiết để bạn có thể đưa ra quyết định đúng đắn khi lựa chọn Mercedes S-Class phù hợp với nhu cầu và ngân sách.",
    ...
    },
    {
      ...
      excerpt: "Tìm hiểu về công nghệ hybrid mới nhất trên các dòng xe Porsche và Mercedes, lợi ích và những điều cần lưu ý.",
      category: "technology",
    ...
    },
    {
      ...
      excerpt: "Hướng dẫn chi tiết cách bảo dưỡng xe Porsche đúng cách, giúp xe luôn trong tình trạng tốt nhất và giữ được giá trị cao.",
    ...
    },
    {
      ...
      excerpt: "Khám phá cách những chiếc xe cao cấp không chỉ là phương tiện di chuyển mà còn là biểu tượng của phong cách sống đẳng cấp.",
      category: "lifestyle",
      categoryLabel: "Phong cách sống",
      author: "Thật Nguyễn",
      date: "03/12/2024",
      readTime: "5 phút đọc",
      image: "https://images.unsplash.com/photo-1452378174528-3090a4bba7b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=4032&q=80",
      featured: false,
      views: 2100,
      comments: 19
    }
