...
const services = [
  {
    ...
    description:
      "Dịch vụ tư vấn 1:1 giúp bạn chọn được chiếc xe phù hợp nhất với nhu cầu, sở thích và ngân sách.",
    features: [
  ...
  },
  {
    ...
    description:
      "Kết nối với các ngân hàng uy tín để có được gói vay với lãi suất ưu đãi và thủ tục đơn giản nhất.",
    features: [
  ...
  },
  {
    ...
    description:
      "Dịch vụ bảo hiểm toàn diện cho xe cao cấp với mức bảo hiểm phù hợp và quy trình bồi thường nhanh chóng.",
    features: [
  ...
  },
  {
    ...
    description:
      "Hỗ trợ hoàn tất toàn bộ thủ tục pháp lý và đăng ký biển số cho xe mới một cách nhanh chóng.",
    features: [
  ...
  },
  {
    ...
    description:
      "Chăm sóc và bảo dưỡng xe định kỳ tại các trung tâm ủy quyền chính hãng với kỹ thuật viên chuyên nghiệp.",
    features: [
  ...
  },
  {
    ...
    description:
      "Hỗ trợ khách hàng 24/7 qua nhiều kênh để giải đáp mọi thắc mắc và hỗ trợ khẩn cấp.",
    features: [
      "Hotline hỗ trợ 24/7",
      ...
      <main className="pt-32">
        ...
        <section className="py-16 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <Badge
              variant="outline"
              className="mb-6 font-inter border-white text-white"
            >
              Dịch vụ chuyên nghiệp
            </Badge>
            <h1 className="font-playfair text-4xl md:text-5xl font-bold mb-6">
              Trải nghiệm dịch vụ
              <span className="block text-luxury-gold mt-5">
                Đẳng cấp & Toàn diện
              </span>
            </h1>
                ...
                >
                  <CardContent className="p-8">
                    ...
                    <div className="flex space-x-4">
                      <Button
                        className="flex-1 font-inter bg-luxury-gold hover:bg-luxury-gold/90 text-black"
                        onClick={() => nav("/contact")}
                      >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="font-inter text-xl text-gray-600">
                  Điền thông tin bên dưới để được tư vấn chi tiết về dịch vụ phù
                  hợp nhất
                </p>
              </div>
