  ...
  const slides = [
    {
      ...
      description:
        "Trải nghiệm cảm giác lái đỉnh cao cùng Porsche 911 - Huyền thoại không bao giờ lỗi thời",
      image:
    ...
    },
    {
      ...
      description:
        "Sang trọng, tinh tế và đầy quyền lực - Mercedes S-Class định nghĩa lại phong cách",
      image:
    ...
    },
    {
      ...
      description:
        "Tư vấn chuyên nghiệp - Dịch vụ đẳng cấp - Trải nghiệm hoàn hảo cho khách hàng VIP",
      image:
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  size="lg"
                  className="font-sans text-lg px-8 py-6 bg-luxury-gold hover:bg-luxury-gold/90 text-black font-medium"
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="font-sans text-lg px-8 py-6 border-white text-white bg-none! hover:bg-white hover:text-black font-medium"
                  onClick={() => nav("/contact")}
                >
                  Liên hệ ngay
                </Button>
