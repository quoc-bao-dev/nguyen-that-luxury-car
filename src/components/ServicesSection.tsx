  ...
  const services = [
    {
      icon: UserCheck,
      title: "Tư vấn mua xe",
      description: "Tư vấn chuyên sâu giúp bạn chọn được chiếc xe phù hợp nhất với nhu cầu và ngân sách.",
      features: ["Phân tích nhu cầu cá nhân", "So sánh các dòng xe", "Tư vấn 1:1 miễn phí"]
    },
    {
      icon: CreditCard,
      title: "Hỗ trợ tài chính",
      description: "Kết nối với các ngân hàng uy tín để có được gói vay với lãi suất ưu đãi nhất.",
      features: ["Lãi suất cạnh tranh", "Thủ tục nhanh chóng", "Tư vấn phương án vay"]
    },
    {
      icon: Shield,
      title: "Bảo hiểm xe",
      description: "Dịch vụ bảo hiểm toàn diện cho xe cao cấp với mức bảo hiểm phù hợp.",
      features: ["Bảo hiểm vật chất", "Bảo hiểm trách nhiệm", "Quy trình bồi thường nhanh"]
    },
    {
      icon: FileText,
      title: "Đăng ký biển số",
      description: "Hỗ trợ hoàn tất toàn bộ thủ tục pháp lý và đăng ký biển số cho xe mới.",
      features: ["Thủ tục trọn gói", "Tiết kiệm thời gian", "Đảm bảo chính xác"]
    },
    {
      icon: Wrench,
      title: "Dịch vụ hậu mãi",
      description: "Chăm sóc và bảo dưỡng xe định kỳ tại các trung tâm ủy quyền chính hãng.",
      features: ["Bảo dưỡng định kỳ", "Phụ tùng chính hãng", "Kỹ thuật viên chuyên nghiệp"]
    },
    {
      icon: MessageCircle,
      title: "Tư vấn 24/7",
      description: "Hỗ trợ khách hàng 24/7 qua nhiều kênh để giải đáp mọi thắc mắc về xe.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Trải nghiệm dịch vụ
            <span className="block text-luxury-gold">Toàn diện & Tận tâm</span>
          </h2>
