      ...
      `}>
            ...
            {menuItems.map((item) => (
              <Link
                ...
                className={`
                  ...
                  ${location.pathname === item.href ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-600 font-medium' : ''}
                `}
              >
                <item.icon className={`w-5 h-5 mr-3 ${location.pathname === item.href ? 'text-blue-600' : 'text-gray-500 group-hover:text-blue-600'}`} />
        ...
        <div className="mx-4 mt-8">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
            <h3 className="text-sm font-semibold text-gray-800 mb-2">Thao tác nhanh</h3>
            <div className="space-y-2">
              <Link 
                to="/admin/posts/new"
