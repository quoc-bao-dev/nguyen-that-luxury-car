      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="animate-fade-in lg:col-span-7">
            ...
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-[60px]">
              Đam mê tạo nên
            ...
            <p className="font-inter text-lg text-gray-600 mb-8 leading-relaxed">
              Với niềm đam mê và hiểu biết sâu sắc về ngành công nghiệp ô tô cao
              cấp, tôi đã dành 5 năm để xây dựng thương hiệu cá nhân với sứ mệnh
              mang đến những trải nghiệm tuyệt vời nhất cho khách hàng yêu xe.
            </p>

            <p className="font-inter text-lg text-gray-600 mb-8 leading-relaxed">
              Không chỉ đơn thuần là việc bán xe, tôi tin rằng mỗi chiếc xe cao
              cấp đều mang trong mình một câu chuyện riêng, và công việc của tôi
              là giúp khách hàng tìm được chiếc xe phù hợp nhất với phong cách
              và cá tính của họ.
            </p>
