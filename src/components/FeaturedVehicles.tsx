...
const vehicles = [
  {
    ...
    price: "8.5 tỷ VND",
    image:
      "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Bộ sưu tập
            <span className="block text-luxury-gold mt-3">Xe nổi bật</span>
          </h2>

          <p className="font-inter text-xl text-gray-600 max-w-3xl mx-auto">
            Khám phá những chiếc xe cao cấp được tuyển chọn kỹ lưỡng, mang đến
            trải nghiệm lái xe đỉnh cao và phong cách sống đẳng cấp.
          </p>
        </div>
          ...
          {vehicles.map((vehicle, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div
                  className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer"
                  onClick={() => nav(`/product/${vehicle.id}`)}
                ></div>
              </div>
